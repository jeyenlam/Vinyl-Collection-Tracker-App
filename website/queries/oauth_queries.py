...
class OAuthQueries:
    ...
    def __init__(self, user_session=None):
        ...
        Args:
            user_session (object): The user session object. Defaults to None.
        """
    ...
    def query_random_vinyls(self):
        ...
        url = (
            ...
            'format=vinyl&sort=year&sort_order=desc&country=us,uk'
        )
        ...
        if 'results' in discogs_data and discogs_data['results']:
            ...
            random.shuffle(discogs_data['results'])
            # Take the first 20 items from the shuffled results
            random_vinyls_list = discogs_data['results'][:20]
    ...
    def query_user_collections(self, user):
        ...
        for folder in folders['folders']:
            ...
            name = folder['name']
            url = (
                f'https://api.discogs.com/users/{user}/collection/'
    ...
    def search(self, search_term):
        ...
        search_vinyls_list = []
        url = (
            f'https://api.discogs.com/database/search?q={search_term}'
            '&format_exact=vinyl&type=master&sort_order=desc'
        )
        ...
        if 'results' in discogs_data and discogs_data['results']:
            # Take the first 20 items from the shuffled results
            search_vinyls_list = discogs_data['results'][:40]
    ...
    def remove_collection(self, user, collection):
        ...
        Args:
            ...
            collection (dict): Collection item details to remove
    ...
    def add_collection(self, user, collection):
        ...
        Args:
            user (str): Discogs user ID
            collection (dict): Collection item details to be added
